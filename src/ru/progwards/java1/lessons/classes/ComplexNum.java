...
public class ComplexNum {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(complexNum1.add(complexNum1, complexNum2));
        System.out.println(complexNum1.sub(complexNum1, complexNum2));
        System.out.println(complexNum1.mul(complexNum1, complexNum2));
        System.out.println(complexNum1.div(complexNum1, complexNum2));
    }
}
